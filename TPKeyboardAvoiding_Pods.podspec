Pod::Spec.new do |s|
  s.name     = 'TPKeyboardAvoiding_Pods'
  s.version  = '1.2.4'
  s.license  = 'zlib'
  s.platform = :ios
  s.summary  = 'A drop-in universal solution for moving text fields out of the way of the keyboard in iOS.'
  s.homepage = 'https://github.com/mrdaios/TPKeyboardAvoiding'
  s.author   = { 'Michael Tyson' => 'michael@atastypixel.com' }
  s.source   = { :git => 'https://github.com/mrdaios/TPKeyboardAvoiding.git', :tag => '1.2.4' }
